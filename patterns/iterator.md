---
description: >-
  Шаблон Итератор применяется когда есть объект, содержащий совокупность данных
  (в виде определенной структуры), а нам необходимо обеспечить доступ к этим
  данным не раскрыв способ хранения данных.
---
